...
const Footer = () => {
  return (
    <footer className="bg-black text-white py-10">
      <section className="relative overflow-hidden py-8 container">
          ...
          <div className="-m-8 flex flex-wrap items-center justify-between">
            ...
            <div className="w-auto p-8">
              <ul className="-m-5 flex flex-wrap items-center">
                <li className="p-5">
                  <a className="font-medium" href="#ABOUT-SECTION">
                    About Us
                  </a>
                </li>
                <li className="p-5">
                  <a className="font-medium" href="#FEATURES-SECTION">
                    FEATURES
                  </a>
                </li>{" "}
                <li className="p-5">
                  <a className="font-medium" href="#PORTFOLIO-SECTION">
                    PORTFOLIO
                  </a>
                </li>
                <li className="p-5">
                  <a className="font-medium " href="#SERVICE-SECTION">
                    SERVICES
                  </a>
                </li>
              </ul>
