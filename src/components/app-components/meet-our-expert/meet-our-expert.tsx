...
const MeetOurExpert = () => {
  return (
    <div className="py-36">
      {/* ExpertTeam SECTION HEADING TITLE START FROM HERE */}
      <section
        id="TEAM-EXPERT-SECTION-HEADING-TEXT"
      ...
      >
        ...
        <h3 className="lg:text-3xl text-xl font-semibold absolute left-1/2 top-3/4 -translate-x-1/2 -translate-y-3/4 inline-block text-black">
          MEET OUR TEAM
        </h3>
      </section>
      {/* ExpertTeam SECTION HEADING TITLE END FROM HERE */}

      {/* EXPERT TEAM MEMBER CARD SECTION START FROM */}
      ...
      {/* EXPERT TEAM MEMBER CARD SECTION END FROM */}
    </div>
  );
};
